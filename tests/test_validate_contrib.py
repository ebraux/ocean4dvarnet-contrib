"""
Unit tests for the `validate_contrib_metadatas` and `validate_all_contrib` functions
...
import os
import shutil
from scripts.validate_contrib_metadatas import validate_contrib_metadatas
...
def test_validate_contrib_metadatas():
    """
    Test the `validate_contrib_metadatas` function to ensure it correctly validates
    ...
    """
    assert validate_contrib_metadatas(f"./contrib/{valid_contrib_name}") is True
    assert validate_contrib_metadatas(f"./contrib/{invalid_contrib_name}") is False
